function isValidServices(selector, data) {
    ...
    if (typeof data !== 'object' ||
        ...
        if (typeof data.maxCount === 'number'){ //jeigu maxcount yra skaicius, 
            if (!isFinite(data.maxCount) ||         // jis turi buti baigtinis
            data.maxCount < 1 ||                // ne mazesnis uz 1
            data.maxCount % 1 !== 0) {          // sveikas skaicius
